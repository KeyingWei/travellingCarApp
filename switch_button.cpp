...
switch_button::switch_button(QWidget *parent) : QWidget(parent)
{
    checked = false;
...
void switch_button::mousePressEvent(QMouseEvent *)
{
    checked = !checked;
...
void switch_button::resizeEvent(QResizeEvent *)
{
    //每次移动的步长为宽度的 50分之一
    step = width() / 50;
...
void switch_button::drawBg(QPainter *painter)
{
    painter->save();
...
void switch_button::drawSlider(QPainter *painter)
{
    painter->save();
     painter->setPen(Qt::NoPen);
...
void switch_button::drawText(QPainter *painter)
{
    painter->save();
...
void switch_button::drawImage(QPainter *painter)
{
    painter->save();
...
void switch_button::updateValue()
{
    if (checked) {
        if (startX < endX) {
            startX = startX + step;
...
void switch_button::setChecked(bool checked)
{
...
void switch_button::setButtonStyle(switch_button::ButtonStyle buttonStyle)
{
    this->buttonStyle = buttonStyle;
    update();
}

void switch_button::setBgColor(QColor bgColorOff, QColor bgColorOn)
{
...
void switch_button::setSliderColor(QColor sliderColorOff, QColor sliderColorOn)
{
...
void switch_button::setTextColor(QColor textColorOff, QColor textColorOn)
{
...
void switch_button::setText(QString textOff, QString textOn)
{
...
void switch_button::setImage(QString imageOff, QString imageOn)
{
...
void switch_button::setSpace(int space)
{
    this->space = space;
    update();
}

void switch_button::setRectRadius(int rectRadius)
{
